...
def register():
    ...
    # 標準MCP対応を登録
    try:
        from Blender_GraphQL_MCP.tools.mcp_standard_integration import register as register_mcp_standard
    ...
    if hasattr(bpy.app, 'handlers') and hasattr(bpy.app.handlers, 'save_pre'):
        ...
        def mcp_save_handler(dummy):
            ...
            # 標準MCPサーバーも停止
            try:
                from Blender_GraphQL_MCP.tools.mcp_server_manager import stop_mcp_server
                stop_mcp_server()
...
def unregister():
    ...
    # 標準MCP対応の登録解除
    try:
        from Blender_GraphQL_MCP.tools.mcp_standard_integration import unregister as unregister_mcp_standard
